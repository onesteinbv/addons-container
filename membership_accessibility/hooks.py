...
def post_init_hook(cr, registry):
    ...
    sale_crm_contacts_access_group = env.ref(
        "membership_accessibility.group_sale_crm_contact_access"
    )
    existing_internal_non_member_users.write(
        {"groups_id": [(4, sale_crm_contacts_access_group.id)]}
    )
