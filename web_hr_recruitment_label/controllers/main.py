...
class WebsiteHrRecruitment(WebsiteHrRecruitment):
    ...
    @http.route(job_routes(), type='http', auth="public", website=True, sitemap=sitemap_jobs)
    def jobs(self, country=None, department=None, office_id=None, contract_type_id=None, label_id=None, **kwargs):
